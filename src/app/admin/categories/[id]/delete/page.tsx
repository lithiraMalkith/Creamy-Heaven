  ...
  return (
    <div className="flex items-center justify-center min-h-[400px]">
      <div className="animate-scale-in max-w-sm w-full bg-brand-white border border-brand-border rounded-xl p-6 space-y-4">
        <h2 className="font-heading text-lg font-semibold text-brand-black">Delete &ldquo;{category.name}&rdquo;?</h2>
        <p className="text-brand-muted text-sm">This will remove the category and all its sub-categories.</p>
        <div className="flex gap-3">
          <a href="/admin/categories" className="btn-hover flex-1 text-center px-4 py-2 border border-brand-border rounded-lg text-brand-black hover:bg-brand-cream">Cancel</a>
